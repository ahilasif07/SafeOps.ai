...
api_router.include_router(procedures.router, prefix="/sops", tags=["Standard Operating Procedures (SOPs) Alias"])
...
api_router.include_router(audit_logs.router, prefix="/audit", tags=["Compliance & Audit Logs"])
api_router.include_router(audit_logs.router, prefix="/audit_logs", tags=["Compliance & Audit Logs Alias"])
